...
function LoginCheck($id,$pass){
	$con = mysqli_connect('localhost','root','123456','pjdb');//DB연결
...
<body>
	...
	<div class="header">
	<img src="img/bug.jpg" style="width:30px;height:30px;"><a class="flea" href="content.php">Plum Game Shop</a>
	</div>
    ...
    <tr>
            <td colspan="3" width="400" > <p style="font-size:40px; color:green"><img src="img/bug.jpg" style="width:50px;height:50px;"><b>Plum Game shop</b></p> </td>
    </tr>
